...
void Box::generateBox() {
	...
	for (int i = 0; i < div; i++) {
		for (int j = 0; j < div; j++) {
			...
			// right:
			Point* a3 = new Point(x, -y + (div_increment_y * i), -z + (div_increment_z * j), normalRightV, (float)(i / div), (float)(j / div)); //D
			points.push_back(a3);

			Point* b3 = new Point(x, -y + (div_increment_y * (i + 1)), -z + (div_increment_z * j), normalRightV, (float)(i+1 / div), (float)(j / div)); //C
			points.push_back(b3);
			...
			// left
			Point* a4 = new Point(-x, -y + (div_increment_y * i), -z + (div_increment_z * j), normalLeftV, (float)(i / div), (float)(j / div)); //D
			points.push_back(a4);
			
			Point* b4 = new Point(-x, -y + (div_increment_y * i), -z + (div_increment_z * (j + 1)), normalLeftV, (float)(i / div), (float)(j+1 / div)); //B
			points.push_back(b4);
			...
			// back
			Point* a6 = new Point(-x + (div_increment_x * i), -y + (div_increment_y * j), -z, normalBackV, (float)(i / div), (float)(j / div)); //C
			points.push_back(a6);
			
			Point* b6 = new Point(-x + (div_increment_x * i), -y + (div_increment_y * (j + 1)), -z, normalBackV, (float)(i / div), (float)(j+1 / div)); //A
			points.push_back(b6);
